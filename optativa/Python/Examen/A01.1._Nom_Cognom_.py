...
Si hi ha algun dau que sigui menor que 3, aleshores la puntuació final és zero punts. En altre cas la puntuació es calcula de la següent manera:
...
Demana per teclat dos valors numèrics. Crea una nova llista amb tots els valors de la 
primera què es troben entre els dos valors entrats per teclat (inclosos), sense valors repetits.
...
Crea un bucle que demani per teclat diversos valors clau (key), fins que el valor sigui 'FI'. Per cada clau, si existeix al diccionari, 
mostra un missatge amb el valor que li correspon. Si no existeix, demana per teclat un valor i afegeix la clau:valor al diccionari.
